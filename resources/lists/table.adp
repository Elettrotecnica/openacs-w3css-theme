          ...
          <if \@paginator.page_count@ gt 1>
            <if \@paginator.group_count@ gt 1 and \@paginator.groupsize@ gt 1>
              <if \@paginator.previous_group_url@ not nil>
                <a class="w3-bar-item w3-button page-link" href="\@paginator.previous_group_url@" title="\@paginator.previous_group_context@">&laquo;</a>
              </if>
              <else>
                <a class="w3-bar-item w3-button w3-disabled page-link" href="#" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
              </else>
              </if>
              <if \@paginator.previous_page_url@ not nil>
                <a class="w3-bar-item w3-button page-link" aria-label="Previous" href="\@paginator.previous_page_url@" title="\@paginator.previous_page_context@"><span aria-hidden="true">&lsaquo;</span></a>
              </if>
              <else>
                <a class="w3-bar-item w3-button w3-disabled page-link" href="#" aria-label="Previous"><span aria-hidden="true">&lsaquo;</span></a>
              </else>
              ...
              <if \@paginator.next_page_url@ not nil>
                <a class="w3-bar-item w3-button page-link" aria-label="Next" href="\@paginator.next_page_url@" title="\@paginator.next_page_context@"><span aria-hidden="true">&rsaquo;</span></a>
              </if>
              <else>
                <a class="w3-bar-item w3-button w3-disabled page-link" href="#" aria-label="Next"><span aria-hidden="true">&rsaquo;</span></a>
              </else>
              <if \@paginator.group_count@ gt 1 and \@paginator.groupsize@ gt 1>
                <if \@paginator.next_group_url@ not nil>
                  <a class="w3-bar-item w3-button page-link" href="\@paginator.next_group_url@" title="\@paginator.next_group_context@">&raquo;</a>
                </if>
                <else>
                  <a class="w3-bar-item w3-button w3-disabled page-link" href="#" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
                </else>
              </if>
            </if>
...
<div class="w3-responsive">
  <table class="w3-table-all" @list_properties.table_attributes;noquote@>
            ...
            <th class="@elements.class@"@elements.cell_attributes;noquote@ id="@list_properties.name@_@elements.name@" nowrap>
              <if @elements.orderby_url@ not nil>
                <if @elements.ordering_p;literal@ true>
                  ...
                  <a href="@elements.orderby_url@" title="@elements.orderby_html_title@">
