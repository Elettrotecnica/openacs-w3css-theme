...
<nav class="w3-sidebar w3-bar-block w3-hide-small w3-center w3-grey oacs-navbar"
     id="oacs-navbar-large">
  <div class="w3-bar-item w3-padding-large w3-border w3-white">
...
<div class="w3-top w3-hide-large w3-hide-medium w3-grey oacs-navbar" id="oacs-navbar-small">
